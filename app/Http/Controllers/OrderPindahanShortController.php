...
class OrderPindahanShortController extends Controller
{
    ...
    {
        $hargas = OrderPindahanShort::oldest()  // Menggunakan oldest() untuk mengurutkan dari yang paling tua ke yang paling baru
    ...
    {
        $hargas = OrderPindahanShort::findOrFail($id);
        // $regencies = Regency::all();
        $provinces = Province::all();
        return view('pages/orderpindahanshort/edit', compact('hargas', 'provinces'));
    }

    public function update(Request $request, $id)
    {
        $order = OrderPindahanShort::findOrFail($id);
        ...
        return redirect()->route('order-pindahanshort')->with('success', 'Data berhasil diperbarui.');
    }
}
