        ...
        <ul>
            <li>
                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3"
                    href="https://instagram.com/muhammadzaaaky?utm_source=qr&igshid=MzNlNGNkZWQ4Mg%3D%3D"
                    target="_blank" @click="open = false" @focus="open = true" @focusout="open = false">
            ...
            <li>
                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 flex items-center py-1 px-3"
                    href="https://wa.me/6289522224418" target="_blank" @click="open = false" @focus="open = true"
                    @focusout="open = false">
                    <svg class="w-3 h-3 fill-current text-indigo-300 dark:text-indigo-500 shrink-0 mr-2"
                        viewBox="0 0 12 12">
                        <path
