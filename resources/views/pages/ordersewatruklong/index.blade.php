<x-app-layout>
    @section('title', 'OrderSewaTrukLongTrip | Pilar')
        ...
        <div class="grid grid-cols-12 gap-6">
            <div
                ...
                <header class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                    <h2 class="font-semibold text-slate-800 dark:text-slate-100">List Order Longtrip Sewa Truk</h2>
                </header>
                <div class="p-3">
                            ...
                            <tbody class="text-sm font-medium divide-y divide-slate-100 dark:divide-slate-700">
                                @foreach ($hargas as $harga)
                                    <tr>
                                        ...
                                        <td class="p-2">
                                            <a href="/edit-orderlongsewa/{{ $harga->id }}"
