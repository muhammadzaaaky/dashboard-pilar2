<x-app-layout>
    @section('title', 'EditLongPindahan | Pilar')
    <!-- component -->
    <form class="flex h-screen bg-gray-100 rounded-md p-2px" action="/update-pindahanlongtrip/{{ $hargas->id }}"
                ...
                <div class="mt-2 bg-white rounded-lg shadow">
                    <div class="flex">
                        <div class="flex-1 py-5 pl-5 overflow-hidden">
                            <h1 class="inline text-2xl font-semibold leading-none">Edit Harga Baru Pindahan Longtrip
                            </h1>
                        </div>
                    </div>
                    <div class="px-5 pb-2">
                        <div class="grid grid-cols-2 sm:grid-cols-2 gap-2">
                            <div>
                                <select placeholder="Origin Provinsi" type="text" id="origin_provinsi"
                                    ...
                                    <option value="{{ $hargas->origin_provinsi }}">{{ $hargas->origin_provinsi }}
                                    </option>
