<x-app-layout>
    @section('title', 'AddDataLongSewaTruk | Pilar')
    <!-- component -->
    <form class="flex h-screen bg-gray-100 rounded-md p-2px" action="/data" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="m-auto">
            <div>
                <div class="mt-2 bg-white rounded-lg shadow">
                    <div class="flex">
                        <div class="flex-1 py-5 pl-5 overflow-hidden">
                            <h1 class="inline text-2xl font-semibold leading-none">+ Tambah Harga Baru Longtrip Sewa Truk
                            </h1>
                        </div>
                    </div>
                    <div class="px-5 pb-2">
