<x-app-layout>
    <!-- component -->
    <form class="flex h-screen bg-gray-100 rounded-md p-2px" action="/update-longsewatruk/{{ $hargas->id }}"
                ...
                <div class="mt-2 bg-white rounded-lg shadow">
                    <div class="flex">
                        <div class="flex-1 py-5 pl-5 overflow-hidden">
                            <h1 class="inline text-2xl font-semibold leading-none">Edit Harga Baru Sewa Truk Longtrip
                            </h1>
                        </div>
                    </div>
                    <div class="px-5 pb-2">
