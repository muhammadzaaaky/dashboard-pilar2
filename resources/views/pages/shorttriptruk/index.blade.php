                        ...
                        <table class="table-auto w-full dark:text-slate-300">
                            ...
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th class="p-2">
                                        <div class="font-semibold text-center">Origin Kec-Kel</div>
                                    </th>
                                    <th class="p-2 m-2">
                                        <div class="font-semibold text-left">Destinasi Kabupaten</div>
                                    </th>
                                    <th class="p-2">
                                        <div class="font-semibold text-center">Destinasi Kec-Kel</div>
                                    </th>
                                    <th class="p-2">
                                        <div class="font-semibold text-center">Armada</div>
                                    </th>
                                    <th class="p-2">
                                        <div class="font-semibold text-center">Jarak</div>
                                    </th>
                                    <th class="p-2">
                                        ...
                                        <td class="p-2">
                                            <div class="text-center">
                                                <button
                                                    ...
                                                    <a href="/edit-shorttriptruk/{{ $harga->id }}">Edit</a>
                                                </button>
                                                <button
                                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                                    <a href="/delete-shortsewatruk/{{ $harga->id }}">Delete</a>
                                                </button>
                                            </div>
                                        </td>
                                    </tr>
